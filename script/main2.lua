...
function parse(tokens)
  ...
  function parse_table()
    -- consume("T_LBRACE", "Expected '{' to begin table")
  ...
  function parse_expression()
      ...
      while match("T_OPERATOR") or match("T_DOT") do
          ...
          elseif match("T_DOT") then
              ...
              left = {type = "TableAccess", base = left, property = property} --Creates inline object
          end
      end
      return left
  end
  ...
  function parse_statement()
    ...
    elseif token.type == "T_IDENTIFIER" then
      ...
      if tokens[i+1] and tokens[i+1].type == "T_OPERATOR" and tokens[i+1].value == "=" then
        return parse_assignment_statement()
      else
        -- Handle the identifier as part of an expression (or other construct)
        return parse_expression() -- Or some other appropriate parsing function
      end
